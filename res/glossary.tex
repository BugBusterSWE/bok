...
\newglossarentry{configurationitem}{
name=configuration item,
description={[SWEBok 6-6]Un configuration item è un elemento o un'aggragazione di hardware e/o software che può essere gestito come una singola entità.}
}

\newglossarentry{softwareconfigurationitem}{
name=software configuration item,
description={[SWEBok 6-6]Un software configuration item è unìentità software che è stata stabilita come configuration item.}
}

\newglossaryentry{SCM}{
name=Software Configuration Management (SCM),
description= [SWEBok 6-1] L'SCM è un processo di supporto al ciclo di vita di un software che avvantaggia la gestione di progetto, le attività di sviluppo e manutenzione, l'attività di garanzia di qualità, così come gli utenti e i clienti del prodotto finale.
}
...
\item [SWEBok 6-7] La baseline è una versione approvata di un configuration item che è stata formalmente progettata e definita (/sistemata, "fixed") in un momento specifico del ciclo di vita del configuration item.
}

\newglossaryentry{versione}{
name=versione,
description= [SWEBok 6-7] La versione di un elemento software è un'istanza identificata dell'elemento stesso. Può essere pensata come uno stato di un elemento in evoluzione.
}
