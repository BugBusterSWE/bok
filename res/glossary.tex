...
description={Un configuration item è un elemento o un'aggragazione di hardware e/o software che può essere gestito come una singola entità.[SWEBok 6-6]}
}

\newglossaryentry{softwareconfigurationitem}{
name=software configuration item,
description={Un software configuration item è unìentità software che è stata stabilita come configuration item.[SWEBok 6-6]}
}
...
name=versione,
description={La versione di un elemento software è un'istanza identificata dell'elemento stesso. Può essere pensata come uno stato di un elemento in evoluzione.[SWEBok 6-7]}
}
